...
ggsave(filename = "./output/supp_figure_2.png", device = "png", width = 8.5, height = 12, units = "in", dpi = 500, limitsize = F)
ggsave(filename = "./output/supp_figure_2.svg", device = "svg", width = 8.5, height = 12, units = "in", dpi = 500, limitsize = F)
