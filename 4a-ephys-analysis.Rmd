...
metadata_m$size = 1
# low microglia cell example: 892441714	SM-GE8YK_S028_E1-50	H18.03.314	ephys_session_id sample_id donor_id # sub-731978186_ses-732048771_icephys.nwb, #355 um deep
# high microglia cell example: 892424119	SM-GE8YK_S031_E1-50	H18.03.314 ephys_session_id sample_id donor_id # sub-731978186_ses-732091715_icephys.nwb #331 um deep
# nwb datasets are on the scc here: /external/rprshnas01/netdata_kcni/stlab/Public/AIBS_patchseq_2020/human/ephys/000023/
...
effects_df_output$signif = ' '
effects_df_output$signif[effects_df_output$p.value < 0.05] = '*'
...
bar_graph_plot = effects_df_output  %>% 
  ...
  geom_signif(stat = "identity", 
              data = effects_df_output %>% filter(signif == '*'),
              aes(x = ephys_prop, xend = ephys_prop, 
                  y = estimate, yend = estimate, 
                  annotation = signif), 
              annotations = annotation
  ) + 
    # annotations = effects_df_output$p.value,
    #           y_position = effects_df_output$estimate, xmin = effects_df_output$ephys_prop, xmax = effects_df_output$ephys_prop,
    #           map_signif_level = T) + 
