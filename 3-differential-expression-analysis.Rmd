...
plot_enrichments_2 = function(res, title, rlimit){
  p = ggplot(res, aes(x = label, y = fdr, size = log10(geneset), color = group)) +
    ...
    scale_color_manual(values = c("reference" = "lightgrey", "patchseq" = "#D43F3AFF"), ) +
...
cols = c("UP" = "#D43F3AFF", "DIFF" = "#9632B8FF", "DOWN" = "#357EBDFF", "NO" = "lightgrey")
...
human_olah_p = plot_enrichments_2(res, "Olah et al. 2020", 1e-65)
human_olah_p
...
mouse_olah_p = plot_enrichments_2(res, "", 1e-65)
mouse_olah_p
