...
p2 = FeaturePlot(seu_h, features = "Microglia", pt.size = 2) +
...
svglite("output/figures/umap_human.svg", width = 11, height = 8)
p2
dev.off()
...
p2 = FeaturePlot(seu_m, features = "Microglia") +
  scale_color_gradientn (colors = pal, labels = seq(0,1,0.2), breaks = seq(0,1,0.2)) +
  guides(color = guide_colourbar(barwidth = 0.5, barheight = 10)) +
  labs(x = "UMAP 1", y = "UMAP 2", title = "", color = "Microglial\nContamination\nScore") + 
  theme_classic() +
...
svglite("output/figures/umap_mouse.svg", width = 11, height = 8)
p2
dev.off()
