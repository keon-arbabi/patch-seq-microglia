...
continous_vars = c("Microglia","age","depth_from_pia_um", "qc_initial_access_resistance_mohm", "rel_recording_time")
...
form_full = Microglia ~ biological_sex + scale(age) + 
  ...
  scale(qc_initial_access_resistance_mohm) + 
...
# metadata_m = metadata_m %>% mutate(slice_id = paste0(donor_id, slice_num_first, ))
...
continous_vars = c("Microglia","age", "rel_recording_time", "qc_initial_access_resistance_mohm")
...
# full model
form_full = Microglia ~ biological_sex + scale(age) + scale(rel_recording_time) + scale(qc_initial_access_resistance_mohm) +
...
# partial model testing
res = lapply(c('biological_sex', 'scale(age)', 'scale(rel_recording_time)', 'scale(qc_initial_access_resistance_mohm)',
...
res$variable = factor(res$variable,
                      levels = c("donor_id","corresponding_AIT2.3.1_alias","scale(age)",
                                 "scale(rel_recording_time)", "scale(qc_initial_access_resistance_mohm)",
                                 "biological_sex"),
                      labels = c("Donor","T-type","Age","Break-in time", "Access res.", "Biological sex"))
res$group = "mouse"
res_m = res %>% as_tibble()
...
ggsave(filename = "./output/figure_2a.svg", device = "svg", width = 16, height = 17, units = "in", dpi = 500, limitsize = F)

ggsave(filename = "./output/figure_2a.png", device = "png", width = 16, height = 17, units = "in", dpi = 500, limitsize = F)


h8
ggsave(filename = "./output/microglia_vs_break_in_time_supp.svg", device = "svg", width = 12, height = 12, units = "in", dpi = 500, limitsize = F)
ggsave(filename = "./output/microglia_vs_break_in_time_supp.png", device = "png", width = 12, height = 8, units = "in", dpi = 500, limitsize = F)
