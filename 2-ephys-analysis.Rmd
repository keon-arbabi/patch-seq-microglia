...
```
here::i_am('../../GitHub/patch-seq-microglia/patch-seq-microglia.Rproj')
...
metadata_h[metadata_h$ephys_session_id == 732048771, 'color'] = 'cyan'
metadata_h[metadata_h$ephys_session_id == 732048771, 'size'] = 3

metadata_h[metadata_h$ephys_session_id == 732091715, 'color'] = 'red'
metadata_h[metadata_h$ephys_session_id == 732091715, 'size'] = 3
...
svglite("output/figures/ephys_plot.svg", width = 6, height = 8)
full_plot
dev.off()
