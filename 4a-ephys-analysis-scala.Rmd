...
metadata_scala %>% group_by(`RNA family`) %>% summarize(corr_val_rmp = cor(Microglia, v_baseline, use = 'pairwise.complete.obs'),
...
ggsave(filename = "./output/scala_figure_4a_supplement.svg", device = "svg", width = 7, height = 12, units = "in", dpi = 500, limitsize = F)

ggsave(filename = "./output/scala_figure_4a_supplement.png", device = "png", width = 7, height = 12, units = "in", dpi = 500, limitsize = F)
