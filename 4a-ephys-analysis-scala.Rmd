...
full_plot = plot_grid(scala_ephys_example_plots, scala_bar_graph_plot, nrow = 2, rel_heights = c(1.3, 1))
full_plot

ggsave(filename = "./output/scala_figure_4a_supplement.svg", device = "svg", width = 7, height = 10, units = "in", dpi = 500, limitsize = F)

ggsave(filename = "./output/scala_figure_4a_supplement.png", device = "png", width = 7, height = 10, units = "in", dpi = 500, limitsize = F)
